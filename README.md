...
**版本说明：** 当前版本为 0.3.1，新增码头/选岛导航、升级及异常恢复、黄条中心偏好和按钮区域随机点击。下载包与验证范围见对应 Release；罕见机制仍在持续完善。
...
| 能力 | 支持范围 |
| --- | --- |
| 钓鱼任务 | 从钓鱼待机、等待或 QTE 接续，处理结算、升级及有限恢复；150402 退出重进待长期验证 |
| 钓场识别与选择 | 已支持五个钓场；可从码头/地图进入所选岛屿，并处理普通换岛确认；不自动购买许可证 |
