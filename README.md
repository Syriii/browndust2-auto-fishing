...
**版本说明：** 当前源码与固定本地 EXE 为 **0.4.2**，优化 EXE 启动、圆角背景绘制和图鉴加载。图鉴仅加载当前可见鱼图，再次打开保留滚动位置；游戏识别资源在开始任务时加载。[0.4.2 正式版](https://github.com/Syriii/browndust2-auto-fishing/releases/tag/v0.4.2)已发布并完成官方下载和 EXE 核验。详情见[当前状态](docs/development/status.md)。
...
![0.4.1 实际 EXE 图鉴界面](docs/images/ui-0.4.1-catalogue.png)
