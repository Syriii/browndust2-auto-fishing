...
本文保留当时的规模、旧模块与选型依据，不作为当前目录清单。现状见[架构说明](../design/architecture.md)，迁移过程见[阶段档案](../history/architecture-2026-09-08.md)；本轮文档整理未重新核验上游资料。
...
- 2026-09-12 源码目录补齐六个钓场，新增天空岛；名称、入口、许可证购买前后已有用户原图，专属机制仍待实际钓鱼样本。
