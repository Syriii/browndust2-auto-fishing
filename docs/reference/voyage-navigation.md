...
资料已确认第六个岛屿名为“天空岛”。[FishingLocation](../../bd2_fishing/game/islands/catalog.py) 已补齐六项，界面、地图识别、OCR 名称匹配和恢复共用同一目录。天空岛暂用通用 QTE 策略，启动时提示未实测；购买前后原图只证明地图与许可证识别，不代表专属机制已验证。
