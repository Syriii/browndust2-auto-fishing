...
更新界面通过 app/updates 编排，基础设施中的 updates 子包负责协议、下载、文件事务与独立助手。app/startup 校验配置；infrastructure/maintenance 仅在发布版待机时执行。均不引入 game/runtime 的反向依赖，不参与 QTE 时序。详见[更新设计](portable-update.md)。
